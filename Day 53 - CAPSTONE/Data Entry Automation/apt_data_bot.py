...
class AptDataBot:
    ...
    def get_apt_data(self):
        """Gets the data of the first page of apartment listings on Zillow.

        2022-03-07 Zillow has used anti web-scraping on their webpage and accessing it with BeautifulSoup causes it
        to return blank HTML elements past a certain point in the UL of listings. Due to this, only 9 listings can be
        retrieved by this code, despite there being 40 per page.
        Run this and scroll down to the ul: print(soup.find(name='ul', class_='photo-cards').prettify())
        Shows that the <li></li> become blank after 9 pieces of data."""
